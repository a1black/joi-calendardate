...
declare module 'joi' {
  ...
  interface CalendardateSchema extends AnySchema {
    ...
    ge(date: 'today' | 'tommorow' | 'yesterday' | string | Date, options?: ComparisonOptions): this;
    ...
    le(date: 'today' | 'tommorow' | 'yesterday' | string | Date, options?: ComparisonOptions): this;
